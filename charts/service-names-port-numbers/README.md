...
[![Latest version](https://img.shields.io/badge/latest_version-0.25.0-blue)](https://artifacthub.io/packages/helm/rm3l/service-names-port-numbers)

## Installation

```bash
$ helm repo add rm3l https://helm-charts.rm3l.org
$ helm install my-service-names-port-numbers rm3l/service-names-port-numbers --version 0.25.0
```
