...
[![Latest version](https://img.shields.io/badge/latest_version-0.17.2-blue)](https://artifacthub.io/packages/helm/rm3l/ghost-export-to-s3)

## Installation

```bash
$ helm repo add rm3l https://helm-charts.rm3l.org
$ helm install my-ghost-export-to-s3 rm3l/ghost-export-to-s3 --version 0.17.2
```
